---
name: captains-chair
description: Use Captain's Chair to baseline repositories, inspect course readiness, and advance policy-gated SDLC work through Codex.
---

# Captain's Chair for Codex

Captain's Chair is the deterministic control plane. Use its CLI or MCP tools for
...
1. Run `captains-chair doctor` before first use or after configuration changes.
...
6. Use `captains-chair usage report` to inspect provider-reported tokens by model,
   role, and stage.
