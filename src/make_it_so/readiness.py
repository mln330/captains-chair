...
def build_readiness_prompt(course: Course, evidence: dict[str, object] | None = None) -> str:
    ...
    return (
        "You are the independent readiness reviewer for Make It So. Inspect the repository "
        ...
        "section describes stages provided by Make It So itself. Do not require a separate project work "
